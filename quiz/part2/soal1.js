...
function attack(damage) {
  // Code disini
  // mengurangi damage yang diberikan sejumlah 2
  return damage - 2;
}

function damageCalculation(numberOfAttacks, damagePerAttack) {
  // Code disini
  // menghitung total damage yang dihasilkan dengan mengalikan numberOfAttacks dan damagePerAttack(sudah dipropres pada fungsi damage)
